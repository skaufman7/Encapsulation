...
public class MainGUI extends javax.swing.JFrame implements ActionListener {
    ...
    /**
     * many of these properties can be removed they are here temporarily until
     * this code gets modularized to prevent errors from popping up all over the
     * place.
     */
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        foundIndex = partmanager.preformSearch(searchNum);
        ...
        if (foundIndex == NOT_FOUND) {
            ...
            txtCurProdNo.setText(partmanager.getIndividualPartNo(foundIndex));
            txtCurDesc.setText(partmanager.getIndividualDesc(foundIndex));
            txtCurPrice.setText("" + partmanager.getIndvidualPrice(foundIndex));
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        tempPrice = Double.parseDouble(txtCurPrice.getText());
        flag = partmanager.preformUpdate(txtCurProdNo.getText(), txtCurDesc.getText(), tempPrice);
    ...
    private void displayList() {
        ...
        for (int i = 0; i < partmanager.getEmptyRow(); i++) {
            String rLine = partmanager.getIndividualPartNo(i) + "\t"
                    + partmanager.getIndividualDesc(i) + "\t\t" + nf.format(partmanager.getIndvidualPrice(i)) + "\n";
